...
class TournamentConfig:
    ...
    def official_120(cls) -> TournamentConfig:
        ...
        return cls(field_size=120)

    @classmethod
    def fast_36(cls) -> TournamentConfig:
        """Fast 36-player research profile (same structure, scaled down field)."""
        return cls(field_size=36)

    @classmethod
    def smoke_24(cls) -> TournamentConfig:
        """Minimal 24-player smoke test profile."""
        return cls(field_size=24)
